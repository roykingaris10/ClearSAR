      ...
      <div className="stagger space-y-8">
        ...
        {sars.length === 0 ? (
          ...
          <div className="overflow-hidden rounded-2xl border border-white/[0.08]">
            <div className="grid grid-cols-12 gap-4 bg-white/[0.02] px-6 py-4 text-[11px] uppercase tracking-[0.12em] text-white/40">
              ...
              {sars.map((s) => {
                ...
                return (
                  <Link
                    key={s.id}
                    href={`/sar/${s.id}`}
                    className="grid grid-cols-12 items-center gap-4 px-6 py-5 transition-colors hover:bg-white/[0.02]"
                  >
